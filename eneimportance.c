/*****************************************************************************/
/*                                                                           */
/* serpent 2 (beta-version) : eneimportance.c                                */
/*                                                                           */
/* Created:       2019/10/16 (JLe)                                           */
/* Last modified: 2019/10/16 (JLe)                                           */
/* Version:       2.1.32                                                     */
/*                                                                           */
/* Description: Handles splitting by energy importance                       */
/*                                                                           */
/* Comments:                                                                 */
/*                                                                           */
/*****************************************************************************/
...
#define FUNCTION_NAME "EneImportance:"

/*****************************************************************************/

long EneImportance(long part, double x, double y, double z,
                   double u, double v, double w, double E0, double E1,
                   double *wgt, double t, long id)
{
  ...
  if ((long)RDB[DATA_ENE_IMP_CALC] == NO)
    return 0;

  /* Get previous importance */

  I0 = pow(E0, RDB[DATA_ENE_IMP_POW]);
  CheckValue(FUNCTION_NAME, "I0", "", I0, 0.0, INFTY);

  /* Get new importance */

  I1 = pow(E1, RDB[DATA_ENE_IMP_POW]);
